...
o = function(patterns, action, options){
  ...
  action = ("console.warn.call(console, '" + patternsOrig + "');") + ((debug = options.debug) ? "console.warn.call(console, " + debug + ");" : '');
  +action;
